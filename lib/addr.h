...
void addr_fromip6(union addr *a, const struct in6_addr *ipaddr);
void addr_fromip6b(union addr *a, uint8_t *bytes);
const struct in6_addr *addr_toip6(const union addr *a);
