...
static inline int
gtp_bpf_assign_program(gtp_bpf_prog_t *p, struct bpf_program *prg,
...
void
gtp_bpf_prog_detach(gtp_bpf_prog_t *p, gtp_interface_t *iface)
{
	int i;
...
int
gtp_bpf_prog_tpl_data_set(gtp_bpf_prog_t *p, const char *tpl_name, void *udata)
{
	int i;
