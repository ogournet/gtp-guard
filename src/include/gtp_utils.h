...
int gtp_apn_labels_cnt(const char *, size_t);
int gtp_apn_extract_str_ni(char *, size_t, char *, size_t);
int gtp_apn_extract_ni(const uint8_t *apn, size_t asize, char *dst, size_t dsize);
