...
int gtp_teid_masq(struct gtp_f_teid *, sockaddr_t *, uint32_t);
int gtp_teid_restore(struct gtp_teid *, struct gtp_f_teid *);
int gtp_teid_update_sgw(struct gtp_teid *, sockaddr_t *);
int gtp_teid_update_pgw(struct gtp_teid *, sockaddr_t *);
