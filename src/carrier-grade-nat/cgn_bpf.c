 ...
 */
static int
cgn_bpf_bind_itf(gtp_bpf_prog_t *p, void *udata, gtp_interface_t *iface)
{
...
static int
cgn_bpf_bound_itf(gtp_bpf_prog_t *p, void *udata, gtp_interface_t *iface)
{
	struct cgn_ctx *c = udata;
...
static void
cgn_bpf_unbind_itf(gtp_bpf_prog_t *p, void *udata, gtp_interface_t *iface)
{
	struct cgn_ctx *c = udata;
	struct cgn_iface_bind *ib;
	int i;
...
static int
cgn_bpf_opened(gtp_bpf_prog_t *p, void *udata)
{
...
static int
cgn_bpf_loaded(gtp_bpf_prog_t *p, void *udata)
{
	struct cgn_ctx *c = udata;
